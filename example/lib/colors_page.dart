...
class ColorsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      ('receivedMessageBubble', colors.receivedMessageBubble),
      ('receivedMessageBubblePressed', colors.receivedMessageBubblePressed),
      ('receivedMessageText', colors.receivedMessageText),
      ('sentMessageBubble', colors.sentMessageBubble),
      ('sentMessageBubblePressed', colors.sentMessageBubblePressed),
      ('sentMessageText', colors.sentMessageText),
